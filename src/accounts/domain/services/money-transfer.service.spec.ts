...
import { ClientId } from "src/owners/domain/aggregates/client/client-id.value";
...
describe('MoneyTransferService', () => {
  ...
  beforeEach(() => {
    ...
    fromAccountNumber = AccountNumber.create('123456789');
    
    toAccountId = AccountId.of(2);
    toAccountNumber = AccountNumber.create('123456788');
